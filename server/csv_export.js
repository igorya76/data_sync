...
async function find_attr(name){
  ...
  switch(name){
    ...
    case 'drawingsheets':
      return ['drawing_date', 'drawing_id', 'id', 'number', 'pdf_url','png_url','title','updated_at','current','revision_number','tumbnail_url','large_thumbnail_url','zip_url','drawing_set.id','drawing_area.id','discipline.id','discipline.name','company_id','project_id','set_id', 'drawing_area_id']
    default:
      null
  }
}
